...
\newcommand{\PTPdGC}{\ToolName{PTPdV2}}
\newcommand{\Vitesse}{\TechName{Vitesse VSC7385}}
\newcommand{\MyRepo}{\TechName{git} Repository}
\newcommand{\Debian}{\TechName{Debian}}
\newcommand{\RedHat}{\TechName{Red-hat}}
\newcommand{\SourceForge}{\TechName{Sourceforge.net}}
\newcommand{\GoogleCode}{\TechName{Google Code}}
