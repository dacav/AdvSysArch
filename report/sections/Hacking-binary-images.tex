...
\end{lstlisting}
    ...
    \Warn{Using \Command{su} or \Command{sudo}}{
        ...
        or the \Command{sudo} command. If you are on a \TechName{Ubuntu}
        system you are likely to be using \Command{sudo} for the
    ...
    program we compiled in Section~\ref{sec:Upload} inside the image.
