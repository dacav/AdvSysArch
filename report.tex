...
\maketitle
    ...
    \label{sec:Overview}
        ...
        \Note{Naming conventions of this document}{
            \begin{itemize}
    ...
    \label{sec:GetTools}
        ...
        As mentioned in Section~\ref{sec:Overview} useful tools and
        configurations are provided in the CD-ROM:
        \begin{itemize}
